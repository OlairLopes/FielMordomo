...
def render():
    ...
    with f2:
        inicio = st.date_input("Inicio", inicio_padrao, key="dashboard_ministerio_inicio", format="DD/MM/YYYY")
    with f3:
        fim = st.date_input("Fim", hoje, key="dashboard_ministerio_fim", format="DD/MM/YYYY")
    with f4:
